...
\msuabbrev{ASA}{A small abbreviation}
\msuabbrev{ABA}{An abbreviation with an explanation so long that the explanation should wrap to the next line and align properly with the previous line}
% Then print the list
\clearpage
\listofabbreviations
\mainmatter
